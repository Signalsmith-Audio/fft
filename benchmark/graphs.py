...
figure, axis = article.wide()
plot_if_exists(axis, "out/results/signalsmith.csv")
plot_if_exists(axis, "out/results/dev-history-repeated-twiddles.csv")
plot_if_exists(axis, "out/results/dev-history-ping-pong.csv")
plot_if_exists(axis, "out/results/dev-history-specialised235.csv")
plot_if_exists(axis, "out/results/dev-history-specialised23.csv")
plot_if_exists(axis, "out/results/dev-history-unspecialised.csv")
